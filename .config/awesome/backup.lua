...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,"Shift"    }, "s", function () awful.spawn("spectacle -r") end,
              {description = "open spectacle region", group = "launcher"}),
    ...
    -- FN keys
    awful.key({ }, "#232", function () awful.spawn("light -U 1")                end,
              {description = "brightness down", group = "fn keys"}),
    awful.key({ }, "#233", function () awful.spawn("light -A 1")                end,     
    ...
    awful.key({ }, "#123", function () awful.spawn("amixer set 'Master' 5%+")                end,                                                                                                                                                                                        {description = "volume up", group = "fn keys"}),
    awful.key({ }, "#172", function () awful.spawn("playerctl play-pause")                end,                                                                                                                                                                                           {description = "volume up", group = "fn keys"}),
